...
** dynamic array func
*/
void				ft_vvoid_da_init(t_vvoid_da *vvoid_da, size_t size,
						size_t len);
...
int					ft_charnpos(char *str, char c, size_t len);
int					charpos(char *str, char c);
char				*ft_read_fd(int fd);
size_t				ft_ulong_size(size_t number);
...
void				*insert_mem(char *src, size_t src_size, char *dest,
						size_t dest_size, unsigned int pos);
